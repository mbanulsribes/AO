...
Una tarea urgente no siempre es la más importante. También debes
comprobar si otras tareas dependen de ella.
...
Una solución técnica no está completa si la persona afectada no sabe qué
ha ocurrido o qué debe hacer a continuación.
