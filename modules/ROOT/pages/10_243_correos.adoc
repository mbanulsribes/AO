...
*IMAP* permite consultar y sincronizar el buzón manteniendo los mensajes
en el servidor.

*POP* se asocia al modelo tradicional de descarga de mensajes al
cliente.
...
Ninguna señal aislada demuestra siempre un ataque. Hay que valorar el
conjunto.

=== 4.7 Calendario

Una reunión debe gestionarse preferentemente mediante invitación de
calendario cuando la herramienta lo permita.
...
[arabic]
. Reescribe tres correos mal redactados.
. Crea reglas de clasificación.
. Analiza cinco correos sospechosos.
. Organiza una reunión con tres participantes.
