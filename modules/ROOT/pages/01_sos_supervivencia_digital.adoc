...
*Software libre* no significa necesariamente gratuito. Significa que la
licencia concede libertades como usar, estudiar, modificar y
redistribuir el programa bajo determinadas condiciones.

*Software propietario* está controlado por su titular y su uso depende
...
* *copyleft*: mecanismo que permite reutilización y redistribución
manteniendo determinadas libertades.
...
Un cliente recibe `listado_clientes.ods` pero solo necesita
