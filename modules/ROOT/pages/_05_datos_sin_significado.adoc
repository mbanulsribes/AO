...
Según la aplicación se utilizará `BUSCARV`, `BUSCARX/XLOOKUP` o
...
Es importante que la clave sea coherente y que el rango de búsqueda esté
bien definido.
...
Ocultar todos los errores sin analizarlos puede ocultar problemas
reales.
...
Una tabla dinámica resume grandes conjuntos de datos sin escribir una
fórmula para cada resultado.
...
[arabic]
. Filtra ventas de Valencia superiores a 750 €.
. Completa automáticamente el nombre de producto desde su código.
. Crea un gráfico mensual.
. Crea una tabla dinámica por comercial y trimestre.

== 🔥 6. Nueva incidencia

Dirección formula cinco preguntas sobre un fichero nuevo. Debes decidir
qué herramienta utilizar para responder cada una.
