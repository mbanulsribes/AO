...
Reutiliza datos de la hoja de cálculo cuando ayuden a comunicar el
mensaje.
...
La misma información no se presenta igual a Dirección que a un equipo
técnico.
...
Una diapositiva puede contener varios elementos siempre que todos apoyen
el mismo mensaje.
...
[arabic]
. Rediseña una diapositiva saturada.
. Convierte una tabla en un gráfico útil.
. Crea una presentación de cinco diapositivas.
