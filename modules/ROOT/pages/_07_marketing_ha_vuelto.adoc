...
Puede escalarse sin la misma pérdida de calidad que una imagen de mapa
de bits.
...
Una imagen para una web puede no necesitar el mismo tamaño que una para
impresión.
...
*JPG* - muy usado en fotografía; - compresión con pérdida; - no conserva
transparencia.

*PNG* - conserva transparencia; - adecuado para gráficos y capturas; -
puede pesar más que JPG.

*SVG* - vectorial; - ideal para muchos logos e iconos; - requiere
...
El objetivo no es obtener el archivo más pequeño posible, sino un
equilibrio adecuado al destino.
...
[arabic]
. Compara JPG, PNG y SVG.
. Crea tres tamaños del mismo recurso.
. Elimina un fondo y exporta con transparencia.
. Prepara una cabecera para documento y otra para presentación.
